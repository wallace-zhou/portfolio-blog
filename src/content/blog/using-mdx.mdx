...
pubDate: 'Jun 01 2024'
heroImage: '2025_Chicago/DSC_4517.jpg'
---
...
When you open this page in the browser, you should see the styled date component below.

import FormattedDate from '../../components/FormattedDate.astro';

**Published on:** <FormattedDate date={new Date('2024-06-01')} />
